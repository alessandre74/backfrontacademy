...
class LoginScreen: UIView {
    ...
    lazy var loginLabel: UILabel = {
        let label = UILabel()
//        label.translatesAutoresizingMaskIntoConstraints = false // com SNAPKIT não precisa dessa configuração
    ...
    lazy var emailTextField: UITextField = {
        let tf = UITextField()
//        tf.translatesAutoresizingMaskIntoConstraints = false // com SNAPKIT não precisa dessa configuração
...
//        button.translatesAutoresizingMaskIntoConstraints = false // com SNAPKIT não precisa dessa configuração
    ...
    override init(frame: CGRect) {
        ...
        configPasswordTextFieldContraints()
...
//    }
    ...
    private func configPasswordTextFieldContraints() {
