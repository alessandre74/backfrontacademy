...
class LoginScreen: UIView {
    ...
    lazy var signInMetaMaskViewImageView: UIImageView = {
        let image = UIImageView()
        image.translatesAutoresizingMaskIntoConstraints = false
    ...
    private func addElements() {
        ...
        signInMetaMaskView.addSubview(signInMetaMaskViewImageView)
    ...
    private func configConstraints() {
        NSLayoutConstraint.activate([
            ...
            signInMetaMaskViewImageView.leadingAnchor.constraint(equalTo: signInMetaMaskView.leadingAnchor, constant: 53),
            signInMetaMaskViewImageView.centerYAnchor.constraint(equalTo: signInMetaMaskView.centerYAnchor),
            signInMetaMaskViewImageView.heightAnchor.constraint(equalToConstant: 20),
            signInMetaMaskViewImageView.widthAnchor.constraint(equalToConstant: 20),

            signInMetaMaskLabel.leadingAnchor.constraint(equalTo: signInMetaMaskViewImageView.trailingAnchor, constant: 17),
